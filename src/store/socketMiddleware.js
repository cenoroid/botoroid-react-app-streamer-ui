...
const websocket =
  ...
  async (action) => {
    ...
    if (action.type === "refund") {
      socket.emit("refund", action.payload);
    }
    if (action.type === "updateGoals") {
      socket.emit("savegoals", action.payload);
    }
    if (action.type === "deleteGoal") {
      socket.emit("deletegoal", action.payload);
    }
    ...
    if (action.type === "resetGoal") {
      socket.emit("reset", action.payload);
    }
